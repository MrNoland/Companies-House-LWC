// Source: https://github.com/companieshouse/api-enumerations/blob/master/constants.yml

//Contains translations for the Overview, Officers, UK Establishments, and Insolvency Tabs

const companyTranslationTable = {
  identification_type: {
  ...
  notes: {
    "scottish-insolvency-info":
      "The law requires some Scottish company and LLP insolvency documents be filed with the Accountant in Bankruptcy (AIB). Find further details at [[AIB's register of insolvent companies]](http://roi.aib.gov.uk/ROI/)"
  },
  ...
  register_types: {
    ...
    "persons-with-significant-control":
      "Person(s) with significant control (PSCs)",
...
export default function translateCompany(field, value) {
  return companyTranslationTable[field][value];
}
